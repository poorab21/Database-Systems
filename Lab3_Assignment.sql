-- Task 1
-- select department.deptName,count(employee.employeeID),min(employee.salary) from department join employee on department.deptID=employee.deptID group by department.deptName; 
